...
return {
  {
    ...
    opts = {
      ...
      spec = {
        ...
        {
          mode = { "n", "x" },
          { "<leader>[", group = "Diff get" },
          { "<leader>]", group = "Diff put" },

          { "<leader>[[", "<cmd>diffget<cr>", desc = "Get from other" },
          { "<leader>]]", "<cmd>diffput<cr>", desc = "Put to other" },

          { "<leader>[l", "<cmd>diffget LOCAL<cr>", desc = "Get from LOCAL" },
          { "<leader>[b", "<cmd>diffget BASE<cr>", desc = "Get from BASE" },
          { "<leader>[r", "<cmd>diffget REMOTE<cr>", desc = "Get from REMOTE" },

          { "<leader>[0", "<cmd>diffget 0<cr>", desc = "Get from buffer 0" },
          { "<leader>[1", "<cmd>diffget 1<cr>", desc = "Get from buffer 1" },
          { "<leader>[2", "<cmd>diffget 2<cr>", desc = "Get from buffer 2" },
          { "<leader>[3", "<cmd>diffget 3<cr>", desc = "Get from buffer 3" },
          { "<leader>[4", "<cmd>diffget 4<cr>", desc = "Get from buffer 4" },
          { "<leader>[5", "<cmd>diffget 5<cr>", desc = "Get from buffer 5" },
          { "<leader>[6", "<cmd>diffget 6<cr>", desc = "Get from buffer 6" },
          { "<leader>[7", "<cmd>diffget 7<cr>", desc = "Get from buffer 7" },
          { "<leader>[8", "<cmd>diffget 8<cr>", desc = "Get from buffer 8" },
          { "<leader>[9", "<cmd>diffget 9<cr>", desc = "Get from buffer 9" },

          { "<leader>]0", "<cmd>diffput 0<cr>", desc = "Put to buffer 0" },
          { "<leader>]1", "<cmd>diffput 1<cr>", desc = "Put to buffer 1" },
          { "<leader>]2", "<cmd>diffput 2<cr>", desc = "Put to buffer 2" },
          { "<leader>]3", "<cmd>diffput 3<cr>", desc = "Put to buffer 3" },
          { "<leader>]4", "<cmd>diffput 4<cr>", desc = "Put to buffer 4" },
          { "<leader>]5", "<cmd>diffput 5<cr>", desc = "Put to buffer 5" },
          { "<leader>]6", "<cmd>diffput 6<cr>", desc = "Put to buffer 6" },
          { "<leader>]7", "<cmd>diffput 7<cr>", desc = "Put to buffer 7" },
          { "<leader>]8", "<cmd>diffput 8<cr>", desc = "Put to buffer 8" },
          { "<leader>]9", "<cmd>diffput 9<cr>", desc = "Put to buffer 9" },
        },
